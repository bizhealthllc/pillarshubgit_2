...
const TreeSettings = () => {
  ...
  const handleAdd = () => {
    ...
    setItems((items) => {
      ...
      const newItem = { id: crypto.randomUUID(), widgetId: current?.widgetId, columns: 12, children: [] }
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-6">
                    ...
                    <div className="mb-3">
                      <SelectInput className="form-select" name="frontId" value={frontId} emptyOption="Select Widget" onChange={(name, value) => setFrontId(value)}>
                    ...
                    {widgets && frontId && <>
                      <div className="mb-3" style={{ width: "300px" }}>
                        <SortGridItem id={frontId} col={12} item={{ widgetId: frontId }} widgets={widgets} trees={treeData?.trees} onAdd={handleAddShow} onResize={handleResize} onDelete={handleDelShow} styles={{}} />
                      </div>
                    </>}
                  </div>
                  <div className="col-6">
                    <div className="mb-3">
                      <SelectInput className="form-select" name="bacKId" value={backId} emptyOption="Select Widget" onChange={(name, value) => setBackId(value)}>
                        {widgets && widgets.map((w) => {
                          return <option key={w.id} value={w.id}>{w.name}</option>
                        })}
                      </SelectInput>
                    ...
                    {widgets && backId && <>
                      <div className="mb-3" style={{ width: "300px" }}>
                        <SortGridItem id={backId} col={12} item={{ widgetId: backId }} widgets={widgets} trees={treeData?.trees} onAdd={handleAddShow} onResize={handleResize} onDelete={handleDelShow} styles={{}} />
                      </div>
                    </>}
                  </div>
                </div>
